...
This directory contains Architecture Decision Records (ADRs) for the Hanzo Studio Frontend project.
...
|-----|-------|--------|------|
| [0001](0001-merge-litegraph-into-frontend.md) | Merge LiteGraph.js into Hanzo Studio Frontend | Accepted | 2025-08-05 |
