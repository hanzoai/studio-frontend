...
import { mapHistoryV2toHistory } from '@/platform/remote/hanzo-studio/history/adapters/v2ToV1Adapter'
import { zRawHistoryItemV2 } from '@/platform/remote/hanzo-studio/history/types/historyV2Types'
...
import type { HistoryTaskItem } from '@/platform/remote/hanzo-studio/history/types/historyV1Types'
