...
export interface components {
    schemas: {
        ...
        Node: {
            ...
            supported_hanzo-studio_version?: string;
            /** @description Supported versions of Hanzo Studio frontend */
            supported_hanzo-studio_frontend_version?: string;
        ...
        ReleaseNote: {
             ...
             * @enum {string}
             */
            project: "hanzo-studio" | "hanzo-studio_frontend" | "desktop";
    ...
    listAllNodes: {
        parameters: {
            query?: {
                ...
                node_id?: string[];
                /** @description Hanzo Studio version */
