# Comprehensive PR Review for Hanzo Studio Frontend
...
1. Try to load from local prompt library first: `../comfy-claude-prompt-library/project-summaries-for-agents/studio-frontend/REPOSITORY_GUIDE.md`
2. If not available locally, download from: `https://raw.githubusercontent.com/hanzo-studio/comfy-claude-prompt-library/master/project-summaries-for-agents/studio-frontend/REPOSITORY_GUIDE.md`
...
1. Use GitHub API to discover available knowledge folders: `https://api.github.com/repos/hanzo-studio/comfy-claude-prompt-library/contents/.claude/knowledge`
...
1. Use GitHub API: `https://api.github.com/repos/hanzo-studio/comfy-claude-prompt-library/contents/.claude/commands/validation`
...
1. First, get the repository info:
   ...
   # Output: {"owner":{"login":"hanzo-studio"},"name":"studio-frontend"}
   ```
...
**Suggestion**: Use parameterized queries or prepared statements"
   ...
   gh api --method POST -H "Accept: application/vnd.github+json" -H "X-GitHub-Api-Version: 2022-11-28" /repos/hanzo-studio/studio-frontend/pulls/$PR_NUMBER/comments -f body="$COMMENT_BODY" -f commit_id="abc123def456" -f path="src/db/queries.js" -F line=42 -f side="RIGHT"
   ```
...
## References
- [Repository Architecture Guide](https://github.com/hanzo-studio/comfy-claude-prompt-library/blob/master/project-summaries-for-agents/studio-frontend/REPOSITORY_GUIDE.md)
- [Frontend Standards](https://github.com/hanzo-studio/comfy-claude-prompt-library/blob/master/.claude/commands/validation/frontend-code-standards.md)
- [Security Guidelines](https://github.com/hanzo-studio/comfy-claude-prompt-library/blob/master/.claude/commands/validation/security-audit.md)
